...
-(NSString*)UTIForPath{
    ...
    NSString* tStandardizeSelf = [self stringByStandardizingPath];
    
    NSString* itemUTI = nil;
    BOOL tIsDir = NO;
        if (![[tStandardizeSelf pathExtension] isEqualToString:@""])
        {
...
-(BOOL)conformsToUTI:(NSString*)anUTI{
    return UTTypeConformsTo ((CFStringRef)self,(CFStringRef)anUTI);
}
@end
