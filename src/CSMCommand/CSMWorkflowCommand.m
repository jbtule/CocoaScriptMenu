...
@implementation CSMWorkflowCommand


-(void)CSM_executeOperation{
    [[NSWorkspace sharedWorkspace] openFile:[self filePath] withApplication:@"Automator Launcher" andDeactivate:NO];
}
